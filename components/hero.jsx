      ...
      <div className="text-center z-10 px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Professional image editing powered by AI. Crop , resize and adjust
            colors , remove backgroud and enhance your images with cutting edge
            technology.
          </p>
        ...
        {/* Demo */}
        <div
          className={`relative max-w-4xl mt-10 mx-auto transition-all duration-1000 ${
            textVisible
